var app = new Vue({
    ...
    data: {
        projects: {
            ...
            portfolio: '<div class="close"><i class="fas fa-times"></i></div>' +
            ...
            cycling: '<div class="close"><i class="fas fa-times"></i></div>' +
            ...
            pingpong: '<div class="close"><i class="fas fa-times"></i></div>' +
            ...
            culture: '<div class="close"><i class="fas fa-times"></i></div>' +
            ...
            growth: '<div class="close"><i class="fas fa-times"></i></div>' +
            ...
            learning: '<div class="close"><i class="fas fa-times"></i></div>' +
                '<h3 class="popTitle">Learning</h3>' +
                '<h4 class="popSub" >Some quote about learning would fit here :)</h4>' +
                '<div class="popContent">' +
            ...
            meetups: '<div class="close"><i class="fas fa-times"></i></div>' +
